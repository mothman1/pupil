...
class Plugin_List(object):
    ...
    def add(self,new_plugin,args={}):
        ...
        if self.g_pool.app in ("offline_capture","capture","player") and plugin_instance.alive: #make sure the plugin does not want to be gone already
...
def import_runtime_plugins(plugin_dir):
    ...
    """
    print 'load runtime plugin at ' + plugin_dir
    runtime_plugins = []
        ...
        for d in os.listdir(plugin_dir):
            ...
            try:
                ...
                for name in dir(module):
                    print 'checking runtime plugin ' + name
                    ...
                    if isinstance(member, type) and issubclass(member, Plugin) and member.__name__ != 'Plugin':
                        ...
                        print 'loaded runtime plugin ' + name
            except Exception as e:
                print 'exception loading runtime plugins'
