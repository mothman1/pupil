...
def world(pupil_queue,timebase,launcher_pipe,eye_pipes,eyes_are_alive,user_dir,version,cap_src):
    ...
    from offline_recorder import Recorder
    ...
    system_plugins  = [Recorder,Pupil_Remote]
    ...
    session_settings['eye0_process_alive'] = True # eyes_are_alive[0].value
